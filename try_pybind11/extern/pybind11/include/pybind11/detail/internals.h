...
#define PYBIND11_PLATFORM_ABI_ID                                   \
    PYBIND11_INTERNALS_KIND PYBIND11_COMPILER_TYPE PYBIND11_STDLIB \
        PYBIND11_BUILD_ABI PYBIND11_BUILD_TYPE
...
PYBIND11_NOINLINE internals &get_internals() {
    ...
    struct gil_scoped_acquire_local {
        ...
        gil_scoped_acquire_local &operator=(const gil_scoped_acquire_local &) =
            delete;
    ...
    if (internals_pp && *internals_pp) {
        ...
        if (!PYBIND11_TLS_KEY_CREATE(internals_ptr->tstate)) {
            pybind11_fail(
                "get_internals: could not successfully initialize the tstate "
                "TSS key!");
        }
        ...
        internals_ptr->instance_shards.reset(
...
struct local_internals {
    ...
    local_internals() {
        ...
        loader_life_support_tls_key =
            static_cast<shared_loader_life_support_data *>(ptr)
                ->loader_life_support_tls_key;
    }
#endif  //  PYBIND11_INTERNALS_VERSION == 4
};
